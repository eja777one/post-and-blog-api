...
exports.app.use('/hometask_08/api/auth', _01_authRouter_1.authRouter);
exports.app.use('/hometask_08/api/blogs', _02_blogsRouter_1.blogsRouter);
exports.app.use('/hometask_08/api/comments', _03_commentsRouter_1.commentsRouter);
exports.app.use('/hometask_08/api/posts', _04_postsRouter_1.postsRouter);
exports.app.use('/hometask_08/api/users', _05_usersRouter_1.usersRouter);
exports.app.use('/hometask_08/api/testing/all-data', _06_testsRouter_1.testsRouter);

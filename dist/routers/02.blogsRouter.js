...
class BlogsController {
    constructor() {
        this.blogService = new _02_blogsService_1.BlogService();
...
exports.blogsRouter.post('/', checkAuthMware_1.checkAuthMware, checkReqBodyMware_1.testBlogsReqBody, checkReqBodyMware_1.checkReqBodyMware, blogsController.createBlog.bind(blogsController));
exports.blogsRouter.get('/:id', checkParamMware_1.checkIsObjectId, blogsController.getBlog.bind(blogsController));
exports.blogsRouter.put('/:id', checkAuthMware_1.checkAuthMware, checkParamMware_1.checkIsObjectId, checkReqBodyMware_1.testBlogsReqBody, checkReqBodyMware_1.checkReqBodyMware, blogsController.updateBlog.bind(blogsController));
...
exports.blogsRouter.get('/:blogId/posts', checkParamMware_1.checkIsObjectId, blogsController.getBlogsPosts.bind(blogsController));
exports.blogsRouter.post('/:blogId/posts', checkAuthMware_1.checkAuthMware, checkParamMware_1.checkIsObjectId, checkReqBodyMware_1.testPostsReqBodyNoBlogId, checkReqBodyMware_1.checkReqBodyMware, blogsController.createBlogsPost.bind(blogsController));

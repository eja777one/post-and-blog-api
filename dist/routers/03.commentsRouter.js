...
exports.commentsRouter.put('/:commentId', authMware_1.authMware, checkParamMware_1.checkIsObjectId, checkReqBodyMware_1.testCommentBody, checkReqBodyMware_1.checkReqBodyMware, commentsController.updateComment.bind(commentsController));
exports.commentsRouter.delete('/:commentId', authMware_1.authMware, checkParamMware_1.checkIsObjectId, commentsController.deleteComment.bind(commentsController));
exports.commentsRouter.get('/:commentId', checkParamMware_1.checkIsObjectId, commentsController.getComment.bind(commentsController));

...
let UsersService = class UsersService {
    ...
    createUser(body, ip) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const userInput = db_1.UserModel.makeUserByAdmin(body.login, body.email, passwordHash, passwordSalt, ip);
            const newUserId = yield this.usersRepository.save(userInput);

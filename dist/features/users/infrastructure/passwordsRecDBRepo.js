...
let PasswordRecoveryRepository = class PasswordRecoveryRepository {
    ...
    getData(code) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield db_1.PasswordsRecoveryModel
    ...
    getCode(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield db_1.PasswordsRecoveryModel.collection.findOne({ userId });
            return result;
        });
    }
    deletePasswordData(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield db_1.PasswordsRecoveryModel.deleteOne({ userId });
            return true;
        });
    }
    deleteAll() {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield db_1.PasswordsRecoveryModel.deleteMany({});
            return true;
        });
    }
};

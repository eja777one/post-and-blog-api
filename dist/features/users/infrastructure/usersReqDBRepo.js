...
let UsersRequestRepository = class UsersRequestRepository {
    addLog(userLog) {
        return __awaiter(this, void 0, void 0, function* () {
            const usersLogs = yield db_1.UsersRequestModel
                .create({
                _id: userLog._id,
                ip: userLog.ip,
                url: userLog.url,
    ...
    getLogs(userLog, attemmptTime) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield db_1.UsersRequestModel.countDocuments({
                ip: { $regex: userLog.ip },
    ...
    deleteAll() {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield db_1.UsersRequestModel.deleteMany({});
            return result.deletedCount;
        });
    }
};
UsersRequestRepository = __decorate([

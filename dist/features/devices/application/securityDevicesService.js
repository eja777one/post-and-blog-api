...
const tokensDBRepo_1 = require("../infrastructure/tokensDBRepo");
const tokensQRepo_1 = require("../infrastructure/tokensQRepo");
...
SecurityDevicesService = __decorate([
    ...
    __param(1, (0, inversify_1.inject)(tokensQRepo_1.TokensQueryMetaRepository)),

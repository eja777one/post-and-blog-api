...
const commentsService_1 = require("../../comments/application/commentsService");
...
let PostsController = class PostsController {
    ...
    getPost(req, res) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.postsService.getPost(req.params.id, (_a = req.user) === null || _a === void 0 ? void 0 : _a.id);
    ...
    getPosts(req, res) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield this.postsService.getPosts(query, (_a = req.user) === null || _a === void 0 ? void 0 : _a.id);
            res.status(result.statusCode).json(result.data);
        });
    }
    createPost(req, res) {
    ...
    changeLikeStatus(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.postsService.changeLikeStatus(req.params.postId, req.body.likeStatus, req.user.id, req.user.login);
